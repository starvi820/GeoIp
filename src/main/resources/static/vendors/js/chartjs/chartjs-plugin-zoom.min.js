...
! function e(t, o, n) {
    ...
    2: [function(e, t, o) {
        ...
        function u(e, t, o, a) {
            ...
            if (r && z.getValueOrDefault(r.enabled, M.zoom.enabled)) {
                var l = z.getValueOrDefault(e.options.zoom.mode, M.zoom.mode);
                r.sensitivity = z.getValueOrDefault(e.options.zoom.sensitivity, M.zoom.sensitivity);
                var m;
        ...
        function v(e, t, o) {
            var a = e.options.pan;
            if (a && z.getValueOrDefault(a.enabled, M.pan.enabled)) {
                var i = z.getValueOrDefault(e.options.pan.mode, M.pan.mode);
                a.speed = z.getValueOrDefault(e.options.pan.speed, M.pan.speed), z.each(e.scales, function(e, r) {
        ...
        t.exports = _, h.pluginService.register(_)
    }, {
        "chart.js": 1,
        hammerjs: 1
    }]
